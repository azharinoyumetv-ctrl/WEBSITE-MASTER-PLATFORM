...
const ID: Record<string, string> = {
  ...
  'Workspace active': 'Ruang kerja aktif', 'Connectivity healthy': 'Konektivitas sehat', 'A clear view of the commercial and operational signals that matter today.': 'Tampilan ringkas sinyal perdagangan dan operasional yang penting hari ini.', 'Total Revenue': 'Total Pendapatan', 'Page Views': 'Tayangan Halaman', 'Total Orders': 'Total Pesanan', 'Conversion Rate': 'Rasio Konversi', 'View details': 'Lihat detail',
