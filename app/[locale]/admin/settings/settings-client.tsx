                  ...
                  <div>
                    ...
                    {initialTenant?.subdomain === 'default' ? (
                      ...
                      <div className="flex">
                        ...
                        <div className="px-4 py-2.5 bg-slate-100 border border-slate-200 rounded-r-lg text-sm text-slate-500 font-mono">.{process.env.NEXT_PUBLIC_BASE_DOMAIN || 'wmp.dagangos.com'}</div>
                      </div>
                    )}
